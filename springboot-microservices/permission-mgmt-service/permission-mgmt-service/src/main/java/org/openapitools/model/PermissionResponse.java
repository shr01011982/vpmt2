...
public class PermissionResponse {
  ...
  public PermissionResponse id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PermissionResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  @Schema(name = "name", example = "VIEW_REPORTS", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  @Schema(name = "description", example = "Grants access to view reports", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, permissionResponse.id) &&
        Objects.equals(this.name, permissionResponse.name) &&
