...
public class PermissionRequest {
  ...
  public PermissionRequest name(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  @NotNull @Size(max = 15) 
  @Schema(name = "name", example = "VIEW_REPORTS", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
  ...
  @Schema(name = "description", example = "Grants access to view reports", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, permissionRequest.name) &&
